...
class AgentSettings(BaseModel):
    ...
    windows_context_config: Optional[Any] = None
...
class AgentState(BaseModel):
    ...
    message_manager_state: Any = None  # This will be set by the Agent class
...
class WindowStateHistory(BaseModel):
    """History of window state"""
    
    title: str
    process_name: str
    interacted_element: list[Optional[DOMHistoryElement]]
    ...
    def to_dict(self) -> dict[str, Any]:
        return {
            ...
            'interacted_element': [el.model_dump() if el else None for el in self.interacted_element],
        }
...
class AgentHistoryList(BaseModel):
    ...
    def model_actions_filtered(self, include: list[str] | None = None) -> list[dict]:
        """Get all model actions from history filtered by action name"""
        if include is None:
            include = []
