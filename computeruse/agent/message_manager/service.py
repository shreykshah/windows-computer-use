...
from computeruse.agent.message_manager.views import MessageMetadata, MessageManagerState
from computeruse.agent.prompts import AgentMessagePrompt
from computeruse.agent.views import ActionResult, AgentOutput, AgentStepInfo
...
class MessageManager:
    ...
    def _init_messages(self) -> None:
        ...
        tool_calls = [
            {
                ...
                'args': {
                    'current_state': {
                        'evaluation_previous_goal': 'Success - I launched Notepad',
                        'memory': 'Starting with the new task. I have completed 1/3 steps',
                        'next_goal': 'Type "Hello World" in Notepad',
                    },
                    'action': [{'input_text': {'index': 0, 'text': 'Hello World'}}],
                },
        ...
        self.add_tool_message(content='Started Windows automation')
    ...
    def add_state_message(
        ...
        """Add window state as human message"""
