...
from computeruse.controller.registry.views import (
    ActionModel,
    ActionRegistry,
    RegisteredAction,
)
...
class Registry(Generic[Context]):
    ...
    def _create_param_model(self, function: Callable) -> Type[BaseModel]:
        ...
        params = {
            ...
            if name != 'windows_context' and name != 'page_extraction_llm' and name != 'available_file_paths'
        }
    ...
    async def execute_action(
        ...
        action_name: str,
        params: dict,
        windows_context: Optional[WindowsContext] = None,
        ...
        try:
            ...
            # Check if the action requires windows_context
            if 'windows_context' in parameter_names and not windows_context:
                raise ValueError(f'Action {action_name} requires windows_context but none provided.')
            ...
            if 'windows_context' in parameter_names:
                extra_args['windows_context'] = windows_context
